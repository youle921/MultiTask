...
public class island_shortnote_main {
	public static void main(String args[]) throws IOException, JMException, ClassNotFoundException {
		...
		algorithm1 = algorithm_setting(problem1, Integer.parseInt(args[1]), Integer.parseInt(args[2]));

		String pf1 = "PF/" + problem1.get(0).getHType() + ".pf";

		ProblemSet problem2 = new ProblemSet();
		problem2.add(problemSets.get(1));
		algorithm2 = algorithm_setting(problem2, Integer.parseInt(args[1]), Integer.parseInt(args[2]));
	...
	public static NSGAII_for_shortnote algorithm_setting(ProblemSet problemSet, int interval, int size)
			throws JMException {
