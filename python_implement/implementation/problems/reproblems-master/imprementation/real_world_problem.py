...
class RE23():
    ...
    def evaluate(self, x):
        ...
        #First original objective function
        f[0] = (0.6224 * x1 * x3* x4) + (1.7781 * x2 * x3**2) + (3.1661 * x1**2 * x4) + (19.84 * x1**2 * x3)
...
class RE25():
    ...
    def __init__(self):
        ...
        self.feasible_vals = np.array([[0.009, 0.0095, 0.0104, 0.0118, 0.0128, 0.0132, 0.014, 0.015, 0.0162, 0.0173, 0.018, 0.02, 0.023, 0.025, 0.028, 0.032, 0.035, 0.041, 0.047, 0.054, 0.063, 0.072, 0.08, 0.092, 0.105, 0.12, 0.135, 0.148, 0.162, 0.177, 0.192, 0.207, 0.225, 0.244, 0.263, 0.283, 0.307, 0.331, 0.362, 0.394, 0.4375, 0.5]]).T
...
class RE32():
    ...
    def evaluate(self, x):
        ...
        tmpVar = tauDash**2 + ((2 * tauDash * tauDashDash * x2) / (2 * R)) + tauDashDash**2
        tau = np.sqrt(tmpVar)
...
class RE33():
    ...
    def evaluate(self, x):
        ...
        g[2] = 1.0 - (2.22 * 1e-3 * x3 * (x2**3 - x1**3)) / ((x2**2 - x1**2)**2)
        g[3] = (2.66 * 1e-2 * x3 * x4 * (x2**3 - x1**3)) / (x2**2 - x1**2) - 900.0
        g = np.where(g < 0, -g, 0)
        f[2] = g.sum(axis = 0)
...
class RE34():
    ...
    def evaluate(self, x):
        ...
        f[1] = 6.5856 + (1.15 * x1) - (1.0427 * x2) + (0.9738 * x3) + (0.8364 * x4) - (0.3695 * x1 * x4) + (0.0861 * x1 * x5) + (0.3628 * x2 * x4)  - (0.1106 * x1**2)  - (0.3437 * x3**2) + (0.1764 * x4**2)
        f[2] = -0.0551 + (0.0181 * x1) + (0.1024 * x2) + (0.0421 * x3) - (0.0073 * x1 * x2) + (0.024 * x2 * x3) - (0.0118 * x2 * x4) - (0.0204 * x3 * x4) - (0.008 * x3 * x5) - (0.0241 * x2**2) + (0.0109 * x4**2)
...
class RE35():
    ...
    def evaluate(self, x):
        ...
        f[0] = 0.7854 * x1 * x2**2 * (((10.0 * x3**2) / 3.0) + (14.933 * x3) - 43.0934) - 1.508 * x1 * (x6**2 + x7**2) + 7.477 * (x6**3 + x7**3) + 0.7854 * (x4 * x6**2 + x5 * x7**2)
...
class RE37():
    ...
    def evaluate(self, x):
        ...
        # f1 (TF_max)
        f[0] = 0.692 + (0.477 * xAlpha) - (0.687 * xHA) - (0.080 * xOA) - (0.0650 * xOPTT) - (0.167 * xAlpha**2) - (0.0129 * xHA * xAlpha) + (0.0796 * xHA**2) - (0.0634 * xOA * xAlpha) - (0.0257 * xOA * xHA) + (0.0877 * xOA**2) - (0.0521 * xOPTT * xAlpha) + (0.00156 * xOPTT * xHA) + (0.00198 * xOPTT * xOA) + (0.0184 * xOPTT**2)
        # f2 (X_cc)
        f[1] = 0.153 - (0.322 * xAlpha) + (0.396 * xHA) + (0.424 * xOA) + (0.0226 * xOPTT) + (0.175 * xAlpha**2) + (0.0185 * xHA * xAlpha) - (0.0701 * xHA**2) - (0.251 * xOA * xAlpha) + (0.179 * xOA * xHA) + (0.0150 * xOA**2) + (0.0134 * xOPTT * xAlpha) + (0.0296 * xOPTT * xHA) + (0.0752 * xOPTT * xOA) + (0.0192 * xOPTT**2)
        # f3 (TT_max)
        f[2] = 0.370 - (0.205 * xAlpha) + (0.0307 * xHA) + (0.108 * xOA) + (1.019 * xOPTT) - (0.135 * xAlpha**2) + (0.0141 * xHA * xAlpha) + (0.0998 * xHA**2) + (0.208 * xOA * xAlpha) - (0.0301 * xOA * xHA) - (0.226 * xOA**2) + (0.353 * xOPTT * xAlpha) - (0.0497 * xOPTT * xOA) - (0.423 * xOPTT**2) + (0.202 * xHA * xAlpha**2) - (0.281 * xOA * xAlpha**2) - (0.342 * xHA**2 * xAlpha) - (0.245 * xHA**2 * xOA) + (0.281 * xOA**2 * xHA) - (0.184 * xOPTT**2 * xAlpha) - (0.281 * xHA * xAlpha * xOA)
...
class RE41():
    ...
    def evaluate(self, x):
        ...
        g[2] = 0.32 -(0.214 + 0.00817 * x5 - 0.045195 * x1 - 0.0135168 * x1 + 0.03099 * x2 * x6 - 0.018 * x2 * x7  + 0.007176 * x3 + 0.023232 * x3 - 0.00364 * x5 * x6 - 0.018 * x2**2)
...
class RE91():
    ...
    def evaluate(self, x):
        ...
        # Second function
        f[1] = np.clip((1.16 - 0.3717* x2 * x4 - 0.00931 * x2 * x10 - 0.484 * x3 * x9 + 0.01343 * x6 * x10 )/1.0, 0, None)
        # Third function
        f[2] = np.clip((0.261 - 0.0159 * x1 * x2 - 0.188 * x1 * x8 - 0.019 * x2 * x7 + 0.0144 * x3 * x5 + 0.87570001 * x5 * x10 + 0.08045 * x6 * x9 + 0.00139 * x8 * x11 + 0.00001575 * x10 * x11)/0.32, 0, None)
        # Fourth function
        f[3] = np.clip((0.214 + 0.00817 * x5 - 0.131 * x1 * x8 - 0.0704 * x1 * x9 + 0.03099 * x2 * x6 - 0.018 * x2 * x7 + 0.0208 * x3 * x8 + 0.121 * x3 * x9 - 0.00364 * x5 * x6 + 0.0007715 * x5 * x10 - 0.0005354 * x6 * x10 + 0.00121 * x8 * x11 + 0.00184 * x9 * x10 - 0.018 * x2**2)/0.32, 0, None)
        # Fifth function
        f[4] = np.clip((0.74 - 0.61* x2 - 0.163 * x3 * x8 + 0.001232 * x3 * x10 - 0.166 * x7 * x9 + 0.227 * x2**2)/0.32, 0, None)
        # Sixth function
        ...
        # Seventh function
        f[6] =  np.clip((4.72 - 0.5 * x4 - 0.19 * x2 * x3 - 0.0122 * x4 * x10 + 0.009325 * x6 * x10 + 0.000191 * x11**2)/4.0, 0, None)
        # Eighth function
        f[7] =  np.clip((10.58 - 0.674 * x1 * x2 - 1.95  * x2 * x8  + 0.02054  * x3 * x10 - 0.0198  * x4 * x10  + 0.028  * x6 * x10)/9.9, 0, None)
        # Ninth function
        f[8] =  np.clip((16.45 - 0.489 * x3 * x7 - 0.843 * x5 * x6 + 0.0432 * x9 * x10 - 0.0556 * x9 * x11 - 0.000786 * x11**2)/15.7, 0, None)
